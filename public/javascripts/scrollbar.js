    ...
    recalculateLayout: function(){
        if(this.container.scrollHeight <= this.container.offsetHeight)
            ...
            if(this.options.proportional){
                this.handle.style.top = Math.round((last_scroll_height / this.container.scrollHeight) * Element.positionedOffset(this.handle)[1] + 1) + 'px';
                ...
                this.slider.setValue(this.slider.translateToValue(Element.positionedOffset(this.handle)[1]));
            }
        }
    },
